                ...
                BlocBuilder(
                    ...
                    builder: (context, state) {
                      if (state is GetCustomerSuccessState) {
                        billViewModel.customers = state.entity;

                        if (billViewModel.customers.isNotEmpty) {
                          return Container(
                            width: 95.w,
                            height: 25.h,

                            decoration: BoxDecoration(
                                border:Border(bottom: BorderSide(color:AppColors.primaryColor,width: 1.w ))
                          ...
                          return InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Icon(Icons.add_circle,color: AppColors.primaryColor,size: 22.sp,),
                            ),
                          );
                              ...
                              BlocBuilder(
                                  ...
                                  builder: (context, state) {
                                    if (state is GetSupplierSuccessState) {
                                      billViewModel.suppliers = state.entity;

                                      if (billViewModel.suppliers.isNotEmpty) {
                                        return Container(
                                          width: 100.w,
                                          height: 25.h,
          ...
          child: Icon(Icons.add_circle,color: AppColors.primaryColor,size: 22.sp,),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: AppColors.darkPrimaryColor, width: 2.w)),
                      child: Row(
                        children: [
                          InkWell(
                            onTap: () {
