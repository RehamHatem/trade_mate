                  ...
                  child: BlocBuilder(
                    ...
                    builder: (context, state) {
                      if (state is AddProductsInBillSuccessState  ) {
                        if (state.products.isNotEmpty&& bill==BillType.inBill) {
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return BlocListener(
                                ...
                                child: BillProductItem(
                                  ...
                                  update: (p0) {
                                    billViewModel.updateProductInBill(index,p0);
                                  },
                      ...
                      if(bill==BillType.inBill && state is UpdateProductInBillSuccessState ){
                        return BlocListener(
                          bloc: billViewModel,
                          listener: (context, state) {
                            if(state is UpdateProductInBillSuccessState){
                        ...
                        child: ElevatedButton(
                            onPressed: () {
                              ...
                              if (supplier != null &&
                                ...
                                for(int i=0;i<billViewModel.productsInBill.length;i++){
                                  billViewModel.addProductViewModel.addProduct(productsInBill[i]);
                                }
                              } else {
          ...
          if (state is AddBillSuccessState)
            Align(
              ...
              child: Container(
                ...
                padding: EdgeInsets.only(right: 30.w,left: 30.w,top: 16.h,bottom: 16.h),
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Image.asset("assets/images/onlylog.png",fit: BoxFit.cover,)),

                    Container(
                        height: 60.h,
                        width: 60.w,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(50.r),
                            border: Border.all(color: AppColors.greenColor,width: 2.w,),color: Colors.transparent),

                        child: Icon(Icons.check,size: 35.sp,color: AppColors.greenColor,)),
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton.icon(
                            ...
                            style: ButtonStyle(
                                ...
                                shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(15.r))))

                            ),
                            icon: Icon(Icons.share,color: AppColors.whiteColor,size: 22.sp,),
                            label: Text(
                              'Share ',
                              style: Theme.of(context)
                                  .textTheme
                        ...
                        Expanded(
                          child: ElevatedButton.icon(
                            ...
                            icon: Icon(Icons.print,color: AppColors.whiteColor,size: 22.sp,),
                            label: Text(
                              'Print ',
                              style: Theme.of(context)
                                  .textTheme
